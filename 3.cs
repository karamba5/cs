...
namespace Lab2._3
{
    class Program
    {
        ...
        public static void floatingPoint(string num1, string num2)
        {
            ...
            Console.WriteLine("Additional bit: " + (mantissa1 + mantissa2 > Math.Pow(2, 23) && (first - Math.Abs(first) == 0) && (second - Math.Abs(second) == 0)) + "(pred Normalize result)");
            int new_expo;
            ...
            Console.WriteLine("Результат: " + FinishStringWithZeros(Convert.ToString(resultMask, 2), 32) + " ( " + result + " ) ");
